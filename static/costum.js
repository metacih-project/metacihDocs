// Add costum metacih logo
var brand = document.getElementsByClassName('navbar-brand');
brand[0].innerHTML = `
  <img src="/images/brown.png" alt="logo" height="30px" style="margin-right: 10px;">
  <img src="/images/uw-madison.png" alt="logo" height="30px" style="margin-right: 10px;">
  <img src="/images/metapsy.png" alt="logo" height="30px" style="margin-right: 10px;">
