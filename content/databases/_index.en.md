...
icon: ti-harddrives
description: Documentation of the databases included in MetaCIH
type: docs
weight: "2"
---
- - -

<img src="/uploads/books5.jpg" style="width: 100%;height: 250px;object-fit: cover;
 border-radius: 5px; border: 3px solid white; margin: 30px 0;">


<br>

This page provides documentation entries for all databases included in MetaCIH.
...
Each released database has an associated **[Github repository](https://github.com/metacih-project)** in which the latest and all previous versions of the database are stored. The repository also contains a folder called `metadata`, in which additional information is provided for each release.
